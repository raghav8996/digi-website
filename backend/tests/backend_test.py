...
class TestProducts:
    ...
    def test_active_only_filter(self, api, admin_headers):
        ...
        try:
            ...
            assert all(p.get("is_active") for p in active)
        finally:
            api.delete(
...
class TestOffers:
    ...
    def test_active_only_filter(self, api, admin_headers):
        ...
        try:
            ...
            assert all(o.get("is_active") for o in active)
        finally:
...
class TestTestimonials:
    ...
    def test_active_only_filter(self, api, admin_headers):
        ...
        try:
            ...
            assert all(t.get("is_active") for t in active)
        finally:
    ...
    def test_testimonial_crud_flow(self, api, admin_headers):
        ...
        assert not upd2.json()["is_active"]
...
class TestInstagramPosts:
    ...
    def test_instagram_crud_flow(self, api, admin_headers):
        ...
        assert created["is_active"]  # default
