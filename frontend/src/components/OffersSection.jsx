      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-14">
          <div className="max-w-2xl">
            ...
            <h2 className="font-display text-4xl md:text-5xl font-black text-white mt-4 tracking-tighter">
              In-Store Offers.
            </h2>
              ...
              >
                {o.image_url && (
                  <div className="aspect-[16/10] overflow-hidden bg-black relative">
                    ...
                    {o.tag && (
                      <span className="absolute top-3 left-3 rounded-full bg-[#ff007f] text-white text-[10px] uppercase tracking-[0.22em] font-bold px-3 py-1">
                        {o.tag}
                      </span>
                    )}
                  </div>
                ...
                <div className="p-6 flex flex-col grow">
                  {!o.image_url && o.tag && (
                    <span className="inline-flex self-start rounded-full bg-[#ff007f]/15 border border-[#ff007f]/30 text-[#ff007f] text-[10px] uppercase tracking-[0.22em] font-bold px-3 py-1 mb-3">
                      {o.tag}
                    </span>
                  )}
                  ...
                  {o.description && (
                    <p className="text-white/60 text-sm mt-3 leading-relaxed grow">
                      {o.description}
                    </p>
                  )}
                  <div className="mt-5 pt-5 border-t border-white/5 flex flex-wrap items-center justify-between gap-3">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="inline-flex items-center gap-1.5 rounded-full px-4 py-2 text-xs font-bold bg-[#ff007f] text-white hover:bg-[#e60073] transition-colors"
                    >
